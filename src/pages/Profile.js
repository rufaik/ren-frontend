                    ...
                    <div className="upload__image-wrapper relative">
                      ...
                      >
                        ...
                        <div key={index} className=" flex justify-center items-center imgBx rounded-t-full rounded-b-lg">
                          <img src={simpleUser && simpleUser.image !== null ? formatImageUrl(simpleUser.image.url ): image.data_url  } className="rounded-t-full rounded-b-lg w-full h-full object-cover" alt="" width="66%" />
